...
public class SignInActivity extends Activity
    ...
    private void chooseAccount() {
        if (EasyPermissions.hasPermissions(
            ...
            String accountName = getApplicationContext().getSharedPreferences(YOUTUBE_CLIENT_PREFERENCES, Context.MODE_PRIVATE)
    ...
    /**
     * Display an onError dialog showing that Google Play Services is missing
     * or out of date.
     *
